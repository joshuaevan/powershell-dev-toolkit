...
if ($profileExists) {
    ...
    $hasScripts = $profileContent -match 'PowerShellDevToolkit|Connect-SSH|Get-GitQuick|Start-DevServer'
...
Import-Module "$scriptDir\PowerShellDevToolkit" -DisableNameChecking

# Quick reload function
function reload { . `$PROFILE }

Write-Host "PowerShell Dev Toolkit loaded. Type " -NoNewline
